...
import { Grid, Row, Col, Accordion, Panel, ListGroup, ListGroupItem, Button, Label} from 'react-bootstrap';
                        ...
                        <Row>
                            ...
                            <Col xs={8} md={8}lg={8}>
                                <ListGroup>
                                    ...
                                    <ListGroupItem><strong>Average Rating: </strong>  <Label bsStyle="success">{averageRating}</Label></ListGroupItem>
                                </ListGroup>
                            </Col> 
                        </Row>
                        <Row>
